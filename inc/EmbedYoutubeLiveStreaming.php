...
class EmbedYoutubeLiveStreaming {
	 ...
	 */
	public function __construct( $ChannelID, $API_Key, $autoQuery = true, $Width = 720, $Height = 480 ) {
	...
	echo "Debug marker!!!::: Width: " . $this->Width;
	echo "Debug marker!!!::: Height: " . $this->Height;
		...
		if ( 'channel' === $this->resource_type ) {
			...
			ob_start(); ?>
				<div id="wpYouTubeLive" style="width: <?php echo $this->Width ?>px !important; height: <?php echo $this->Height ?>px !important" width="<?php esc_attr( $this->embed_width ); ?>" height="<?php echo esc_attr( $this->embed_height ); ?>"></div>
				<script>
					var wpYTPlayer;
