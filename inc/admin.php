...
<label>Mobile Width: <input type="number" name="youtube_live_settings[mobile_width]" placeholder="360" value="360"></label>
		<label>Mobile Height: <input type="number" name="youtube_live_settings[mobile_height]" placeholder="240" value="240"></label>
	</p>
	<p>
